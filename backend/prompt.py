...
class KnowledgeExpert:
    def __init__(self, cohere_key):
        ...
        self.format_preference = "short point form, limited to 3-5 bullet points" # default
    ...
    def fetch_response(self, question_input, type=None, max_tokens=1250):
    ...
    def create_prompt(self, question_input, type=None):
        ...
        question = f"Explain {question_input} to me like I am a {type}. You must respond in {self.format_preference}.~"
